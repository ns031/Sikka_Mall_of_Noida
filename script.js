...
let pricebtn1=document.getElementById('price-btn-1');
let pricebtn2=document.getElementById('price-btn-2');
let pricebtn3=document.getElementById('price-btn-3');
...
var submitbtn=document.getElementById('submitbtn');
  ...
  submitbtn.addEventListener('click',function(e) {
    ...
    Email.send({
        ...
        Subject : "Enquiry Request - Mall Of Noida",
        Body : body
    }).then(
        Swal.fire({
              title: 'Success',
  ...
  submitbtn1.addEventListener('click',function(e) {
    ...
    Email.send({
        ...
        To : 'contact@savianmoney.com',
        From : "saviandemo@gmail.com",
        Subject : "Price BreakUp Enquiry Request - Mall Of Noida",
        Body : body1
    }).then(
        Swal.fire({
              title: 'Success',
  ...
  submitbtn2.addEventListener('click',function(e) {
    ...
    Email.send({
        ...
        To : 'contact@savianmoney.com',
        From : "saviandemo@gmail.com",
        Subject : "Enquiry Request - Mall Of Noice",
        Body : body2
    }).then(
        Swal.fire({
              title: 'Success',
